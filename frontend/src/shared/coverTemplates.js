...
export const COVER_TEMPLATES = [
  ...
  },
  {
    ...
    description: "Ваши истории заслуживают красивого оформления. Этот шаблон подчеркнёт важность каждого воспоминания.",
  ...
  },
  {
    ...
    description: "Элегантный дизайн для современных историй. Минималистичный стиль подчеркнёт содержание вашей книги.",
