...
const router = createBrowserRouter([
  ...
  { path: '/qa', element: <Protected><QA/></Protected> },
  { path: '/covers', element: <Protected><Covers/></Protected> },
  { path: '/complete', element: <Protected><Complete/></Protected> },
  { path: '/admin/login', element: <AdminLogin/> },
  { path: '/admin', element: <AdminProtected><AdminLayout/></AdminProtected>, children: [
